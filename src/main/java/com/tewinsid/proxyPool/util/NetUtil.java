package com.tewinsid.proxyPool.util;
...
public class NetUtil {
    ...
    private static HttpResponse getResponse(String ip, int port, String url) throws IOException {
        ...
        get.setHeader("User-Agent", "Mozilla/5.0 (iPad; CPU OS 11_0 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like " +
                "Gecko) Version/11.0 Mobile/15A5341f Safari/604.1");
...
//            HttpResponse response = getResponse("127.0.0.1", 1080, url);
    ...
    public static String getInsideOfWallContent(String url) {
        ...
        HttpGet get = new HttpGet(url);
        get.setHeader("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71" +
                ".0.3578.98 Safari/537.36");
        get.setHeader("Cookie", "yd_cookie=8554f8a7-ad51-4025522bd7f2431ba22fe11b930cc9bb9b3f; " +
                "_ydclearance=a1ab074da0ef53e16da06b0e-f3ac-426f-9674-79974267d0eb-1547133269; " +
                "Hm_lvt_1761fabf3c988e7f04bec51acd4073f4=1547126072; " +
                "Hm_lpvt_1761fabf3c988e7f04bec51acd4073f4=1547128288");
        String result = "";
        String temp = "";
        BufferedReader reader = null;
        try {
